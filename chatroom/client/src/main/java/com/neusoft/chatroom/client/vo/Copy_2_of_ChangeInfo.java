...
public class Copy_2_of_ChangeInfo extends JFrame {
	 ...
	 */
	public Copy_2_of_ChangeInfo(Socket s,Userinfo utemp) {
		super();
		this.s =s;
		u = utemp;
		initialize();
	...
	public Copy_2_of_ChangeInfo(Userinfo utemp) {
		super();
		u = utemp;
		initialize();
	}
	...
	public static void main(String[] args) {
		...
		userInfo.setSex("男");
		new Copy_2_of_ChangeInfo(userInfo);
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jlp.setText("   密  码");
//			jLwel = new JLabel();
//			jLwel.setBounds(new Rectangle(28, 2, 305, 35));
//			jLwel.setText("      用 户 信 息 修 改");
//			jLwel.setFont(new Font("新宋体",Font.BOLD,18));
			jluname = new JLabel();
			jluname.setBounds(new Rectangle(30, 58, 59, 28));
			jluname.setText("  用户名");
			jlpOldPasswd = new JLabel();
			jlpOldPasswd.setBounds(new Rectangle(24, 22, 76, 24));
			jlpOldPasswd.setText("    旧密码");
...
//			jContentPane.add(jLwel, null);
	...
	private JTextField getJtfpetname() {
		if (jtfpetname == null) {
			...
			jtfpetname.setBounds(new Rectangle(100, 216, 225, 25));
		}
		return jtfpetname;
	}
	...
	private JTextField getJtfOldPasswd() {
		if (jtfOldPasswd == null) {
			...
			jtfOldPasswd.setBounds(new Rectangle(100, 22, 231, 30));
		}
		return jtfOldPasswd;
	}
