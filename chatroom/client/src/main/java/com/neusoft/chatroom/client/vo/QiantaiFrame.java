...
public class QiantaiFrame extends JFrame {
	 ...
	 */
	public QiantaiFrame(Socket s,Userinfo u2,Socket so) {
		super();
		initialize();
		this.s = s;
		this.so = so;
		...
		if (jfreceive == null) {
			...
			jfreceive.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
				 ...
				 // System.out.println("111111   " + send_ip);
	...
	private JButton getJbcolor() {
		if (jbcolor == null) {
			jbcolor = new JButton();
			jbcolor.setBounds(new Rectangle(220, 233, 71, 25));
			jbcolor.setText("颜色");
			jbcolor.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(e.getSource()==jbcolor){//改变颜色
						  colorStyle = JColorChooser.showDialog(QiantaiFrame.this,"选择字体颜色",colorStyle);
...
}  //  @jve:decl-index=0:visual-constraint="133,-14"
